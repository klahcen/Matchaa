...
export const AuthCard: React.FC<AuthCardProps> = ({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-[#fd297b] via-[#ff5864] to-[#ff655b]">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-9 flex flex-col transition-all duration-300">
        {/* Brand Header */}
        <div className="flex flex-col items-center text-center mb-6">
          <div className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-tr from-[#fd297b] to-[#ff655b] shadow-md shadow-rose-200 mb-3 transform hover:scale-105 transition-transform duration-200">
          ...
          <h1 className="text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#fd297b] to-[#ff655b]">
            matcha
          </h1>
